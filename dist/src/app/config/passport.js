...
passport.use(new LocalStrategy({
    ...
    try {
        ...
        // }
        const isGoogleAuthenticated = user.authAccounts.some((account) => account.provider === AuthProvider.GOOGLE);
...
passport.use(new GoogleStrategy({
    ...
    try {
        ...
        if (existingUser) {
            ...
            const hasGoogleLinked = existingUser.authAccounts.some((acc) => acc.provider === AuthProvider.GOOGLE &&
